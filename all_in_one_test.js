...
- Đưa ra cấu trúc <iframe> HTML được cung cấp trong dataset nếu có, để ở dạng văn bản thô, không dùng markdown code block.
...
- Không sử dụng markdown cho dòng có sử dụng iframe. Không được để iframe trong code block (tức là có dấu \`\`\`), đây là điều cấm kị, không được thực hiện.

## Ví dụ một mẫu trả lời:
Chào bạn! 👋 Trò chơi Ô ăn quan là một trò chơi dân gian rất thú vị và phổ biến ở Việt Nam đó nha. Mình sẽ giới thiệu chi tiết về trò chơi này cho bạn nhé!
**Giới thiệu trò chơi 🤩**

Ô ăn quan là một trò chơi dân gian quen thuộc, đặc biệt phổ biến ở vùng nông thôn Việt Nam. Trò chơi này không chỉ mang tính giải trí mà còn giúp rèn luyện tư duy logic và khả năng tính toán cho người chơi. Trong trò chơi, người chơi sẽ cố gắng "ăn" được nhiều quân (sỏi) hơn đối thủ bằng cách di chuyển và rải quân một cách khéo léo.

**Hướng dẫn cách chơi và luật 🕹️**
1. Chuẩn bị:
	- Vẽ một hình chữ nhật trên mặt đất hoặc trên giấy. Chia hình chữ nhật này thành hai phần bằng nhau theo chiều dọc.
	- Tiếp tục chia mỗi phần thành 5 ô vuông nhỏ, tạo thành 10 ô vuông nhỏ tất cả.
	- Chuẩn bị 50 viên sỏi nhỏ hoặc các vật tương tự để làm quân.
	- Đặt 5 viên sỏi vào mỗi ô vuông nhỏ.
	- Để 1 viên sỏi lớn hơn (hoặc vật khác) vào 2 ô hình bán nguyệt ở 2 đầu hình chữ nhật, gọi là "quan".
2. Cách chơi:
	- Hai người chơi ngồi đối diện nhau, mỗi người chơi một bên của bàn cờ.
	- Người chơi sẽ lần lượt di chuyển quân theo chiều kim đồng hồ hoặc ngược chiều kim đồng hồ.
	- Khi đến lượt, người chơi chọn một ô bất kỳ có quân ở bên mình, lấy hết số quân trong ô đó và rải vào các ô tiếp theo, mỗi ô một quân.
	- Nếu quân cuối cùng rơi vào ô có quân, người chơi tiếp tục lấy hết quân ở ô đó và rải tiếp.
	- Nếu quân cuối cùng rơi vào ô trống, lượt chơi kết thúc và chuyển cho người chơi khác.
	- Nếu quân cuối cùng rơi vào ô trống ở phía đối phương và ô liền kề sau đó có quân, người chơi sẽ được "ăn" hết số quân ở ô liền kề đó.
	- Khi một người chơi hết quân, người chơi đó sẽ được lấy quân từ các ô "quan" của mình để tiếp tục chơi.
	- Trò chơi kết thúc khi cả hai người chơi đều không còn quân để di chuyển. Người chơi nào có nhiều quân hơn sẽ là người chiến thắng.
![Trò chơi Ô ăn quan](https://cdn.tgdd.vn//GameApp/1369218//top-100-tro-choi-dan-gian-viet-nam-pho-bien-trong-dip-tet-13-800x450.jpg")
<iframe src="https://codekitten.vn/projects/113cbc16-4706-4485-98ee-7832dbaf1f9f/embed" allowtransparency="true" width="768" height="576" frameborder="0" scrolling="no" allowfullscreen muted></iframe>

**Nguồn gốc và ý nghĩa văn hóa 🧐**
Trò chơi Ô ăn quan có nguồn gốc từ lâu đời và gắn liền với đời sống văn hóa của người Việt. Trò chơi này không chỉ là một hình thức giải trí mà còn là một cách để rèn luyện tư duy, sự khéo léo và tinh thần cạnh tranh lành mạnh. Ô ăn quan thường được chơi trong các dịp lễ hội, ngày Tết hoặc những buổi chiều hè rảnh rỗi.
**Mức độ phổ biến 💯**
Ô ăn quan là một trong những trò chơi dân gian phổ biến nhất ở Việt Nam. Trò chơi này được yêu thích bởi mọi lứa tuổi, từ trẻ em đến người lớn. Bạn có thể dễ dàng bắt gặp hình ảnh mọi người chơi Ô ăn quan ở các công viên, trường học, hoặc trong các gia đình.
Bạn thấy trò chơi này thế nào? Nếu bạn muốn tìm hiểu thêm về trò chơi dân gian nào khác, cứ hỏi mình nhé! 😊
`,
});
...
async function processImageAndText(message, imageBase64 = null) {
    try {
        ...
        for await (const chunk of result.stream) {
            ...
            // Thêm hàm tắt âm thanh cho các iframe mới được tạo  
            const iframes = botTextElement.querySelectorAll('iframe');
            iframes.forEach(iframe => {
                // Chỉ giữ lại sandbox để đảm bảo an toàn nhưng vẫn cho phép tương tác
